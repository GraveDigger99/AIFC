 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".global-standing__slider")) new core(".global-standing__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                speed: 900,
                navigation: {
                    prevEl: ".global-standing__button-prev",
                    nextEl: ".global-standing__button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.3,
            ...
            mobileSlider();
            const advantagesSlider = document.querySelector(".advantages-block__slider");
            let myAdvantagesSwiper;
            function mobileAdvantagesSlider() {
                if (document.querySelector(".advantages-block__slider ")) {
                    if (window.innerWidth <= 767.98 && "false" == advantagesSlider.dataset.mobile) {
                        myAdvantagesSwiper = new core(".advantages-block__slider ", {
                            modules: [ Navigation, Pagination ],
                            observer: true,
                            observeParents: true,
                            slidesPerView: 4.2,
                    ...
                    if (window.innerWidth > 767.98) {
                        ...
                        if (advantagesSlider.classList.contains("swiper-initialized")) myAdvantagesSwiper.destroy();
                    }
                }
            }
            mobileAdvantagesSlider();
            const ourPeopleSlider = document.querySelector(".our-people-block__slider");
            let myOurPeopleSwiper;
            function mobileOurPeopleSlider() {
                if (document.querySelector(".our-people-block__slider")) {
                    if (window.innerWidth <= 767.98 && "false" == ourPeopleSlider.dataset.mobile) {
                        myOurPeopleSwiper = new core(".our-people-block__slider", {
                            modules: [ Navigation, Pagination ],
                            observer: true,
                            observeParents: true,
                            slidesPerView: 4.2,
                        ...
                        ourPeopleSlider.dataset.mobile = "true";
                    }
                    if (window.innerWidth > 767.98) {
                        ourPeopleSlider.dataset.mobile = "false";
                        if (ourPeopleSlider.classList.contains("swiper-initialized")) myOurPeopleSwiper.destroy();
                    }
                }
            }
            mobileOurPeopleSlider();
...
***************************************************************************** */
        ...
        if (buttons && buttons.length > 0) buttons.forEach((button => {
        ...
        if (infoTypeButtons && infoTypeButtons.length > 0) infoTypeButtons.forEach((infoTypeButton => {
            infoTypeButton.addEventListener("click", handleInfoTypeButtons);
        }));
        const chooseButtons = document.querySelectorAll(".filter-choose__link");
        if (chooseButtons && chooseButtons.length) chooseButtons.forEach((button => {
            button.addEventListener("click", (event => {
                event.preventDefault();
                const chosen = button.getAttribute("data-choose");
                if ("all" === chosen) if (!button.classList.contains("active")) chooseButtons.forEach((btn => btn.classList.add("active"))); else chooseButtons.forEach((btn => btn.classList.remove("active"))); else {
                    button.classList.toggle("active");
                    const allButton = document.querySelector('.filter-choose__link[data-choose="all"]');
                    if (allButton.classList.contains("active")) allButton.classList.remove("active");
                }
            }));
        }));
        window["FLS"] = false;
